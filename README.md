...
This branch has the first iteration of the full `caboodle` program (called caboodle because it is the whole kitten caboodle). In this version there is an interactive CLI that can be used to set parameters.
