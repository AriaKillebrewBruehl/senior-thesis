...
\author{Aria Killebrew Bruehl}
% The month and year that you submit your FINAL draft TO THE LIBRARY (May or December)
\date{May 2023}
\division{Mathematics and Natural Sciences}
\advisor{Advisor Jim Fix}
...
% So are Acknowledgments (proper English spelling)
	...
	I want to thank Will Howes for being the love of my life and always being there for me.
...
% To remove it, comment it out or delete it.
	...
	\begin{tabular}{ll}
		...
		\textbf{NPR}  	&  Non-Photorealistic Rendering\\
...
% \doublespacing
	...
	Hedcuts, portraits crafted using the stipple method of placing many tiny dots and lines to create the desired image, have become a hallmark of the Wall Street Journal. (https://www.wsj.com/video/how-wsj-stipple-drawings-are-made/91955BD8-9F31-4E50-AEF1-26A61B3AA2FB.html) The images are small typically only three by five inches but creating just one portrait can take an illustrator up to five hours to complete (https://www.wsj.com/articles/SB10001424052748704207504575129961786135180). In 2019 the WSJ had a team of only five artists who would spend all day generating these images. (https://www.wsj.com/articles/whats-in-a-hedcut-depends-how-its-made-11576537243) Although nothing can ever replace the look of a hand-drawn image, digital rendering can significantly speed up the process and make this art form more accessible. 
	
\section{Non-Photo Realistic Rendering}


\section{Generating Hedcuts using Artificial Intelligence and Machine Learning}

In recent years various labs such as the Wall Street Journal's Research and Development team have built and artificial intelligence model that quickly render hedcut style portraits based on an input image. (https://www.wsj.com/articles/whats-in-a-hedcut-depends-how-its-made-11576537243) The team was able to overcome many challenges that initially yielded incomplete portraits or disturbing images like those seen in figure x. Although WSJ's AI has done an excellent job rendering hedcuts this work does not necessitate the use of AI and ML.

\section{Generating Hedcuts without using Artificial Intelligence and Machine Learning}
...
\section{Bibliographies}
	Of course you will need to cite things, and you will probably accumulate an armful of sources. This is why BibTeX was created. For more information about BibTeX and bibliographies, see our CUS site (\url{web.reed.edu/cis/help/latex/index.html})%\footnote{\cite{reedweb:2007}}.
	 There are three pages on this topic: {\it bibtex} (which talks about using BibTeX, at \url{/latex/bibtex.html}), {\it bibtexstyles} (about how to find and use the bibliography style that best suits your needs, at \url{/latex/bibtexstyles.html}) and {\it bibman} (which covers how to make and maintain a bibliography by hand, without BibTeX, at at \url{/latex/bibman.html}). The last page will not be useful unless you have only a few sources. There used to be APA stuff here, but we don't need it since I've fixed this with my apa-good natbib style file.
...
\item You can add a Reed Thesis citation%\footnote{\cite{aria:2022}} 
option. The best way to do this is to use the phdthesis type of citation, and use the optional ``type'' field to enter ``Reed thesis'' or ``Undergraduate thesis''. Here's a test of Chicago, showing the second cite in a row%\footnote{\cite{noble:2002}} 
being different. Also the second time not in a row
%\footnote{\cite{reedweb:2007}} 
should be different. Of course in other styles they'll all look the same.
\end{enumerate}
