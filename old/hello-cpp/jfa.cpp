// #include <iostream>
// #include <opencv/4.6.0/include/opencv4/opencv2/opencv.hpp>


// std::<map<std::tuple, std::tuple>> get_seeds(cv::Mat) {
...
//             for j in range(height):
//                 p = (i, j)
//                 pr, pg, pb = input_image.getpixel(p)
...
//                             continue
//                         q = (qi, qj)
//                         qr, qg, qb = input_image.getpixel(q)
